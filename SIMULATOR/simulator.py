...
if __name__ == "__main__":
    simulate_and_eval_hota05(
        dataset_root="./Consegna/SIMULATOR/lecture_example_from_training/test_set/videos",
        predictions_root="./Consegna/SIMULATOR/lecture_example_from_training/Predictions_folder",
        group="10",
        fps=200.0,
        split="test",
        show_window=True,
